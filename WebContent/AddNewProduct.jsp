                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
						 <div class="col-md-12">
                                    ...
                                    <div class="pull-right"><span><input name = "addname" type="text" placeholder="name"></span></div>
                                    <hr>
                                </div>
                               <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="pull-right"><span><input name = "addprice" type="text" placeholder="price"></span></div>
                                    <hr>
                                </div>
								<div class="col-md-12">
                                    <strong>Estimate shipping time</strong>
                                    <div class="pull-right"><span><input name = "addtime" type="text" placeholder="shipping time"></span></div>
                                    <hr>
                                </div>
								<div class="col-md-12">
                                    <strong>Number of items in stock</strong>
                                    <div class="pull-right"><span><input type="text" name = "addstocknumber"placeholder="numbers"></span></div>
                                    <hr>
                                </div>
								<div class="col-md-12">
                                    <strong>Product description</strong>
                                    <div class="pull-right"><span><input type="text" name = "adddescription" placeholder="description"></span></div>
                                    <hr>
                                </div>
								
                                <button type="submit" class="btn btn-primary btn-lg btn-block">Save</button><br/>
