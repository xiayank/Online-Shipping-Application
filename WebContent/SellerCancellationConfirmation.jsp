...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <!--shopping list-->
    <div class="container">
    <h4>The Following items have been cancelled</h4>
	<table id="cart" class="table table-hover table-condensed">
					...
					<tbody>
						<tr>
                            ...
                            <td data-th="Seller">${anOrderItem.products.productName}</td>
    ...
    ${anOrderItem.subTotal}$ has been refunded to your creditcard! 
    </body>
</html>