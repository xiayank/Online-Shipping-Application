...
/**
 * Servlet implementation class SellerCancelOrderTransaction
 */
@WebServlet("/SellerCancelOrderTransaction")
public class SellerCancelOrderTransaction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SellerCancelOrderTransaction() {
        super();
